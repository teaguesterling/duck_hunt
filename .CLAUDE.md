...
A DuckDB extension for parsing test results, build outputs, and CI/CD logs from 105 development tools into a standardized 39-field schema.
...
duck_hunt/
├── src/
│   ├── parsers/              # 17 parser categories, 105 formats
│   │   ├── base/             # IParser interface, BaseParser, ParserRegistry
...
- [docs/formats.md](docs/formats.md) - All 105 format strings
