...
public:
    ...
    std::string getFormatName() const override { return "bgl"; }
    std::string getName() const override { return "bgl"; }
    int getPriority() const override { return 65; }  // Specific format
