...
bool CMakeParser::canParse(const std::string &content) const {
	...
	bool has_cmake_warning =
	    (content.find("CMake") != std::string::npos && content.find("Warning") != std::string::npos);
	return (content.find("CMake Error") != std::string::npos) || has_cmake_warning ||
