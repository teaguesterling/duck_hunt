...
bool JenkinsParser::canParse(const std::string& content) const {
    ...
    return content.find("Started by") != std::string::npos ||
           ...
           content.find("Console Output") != std::string::npos ||
...
bool JenkinsParser::isJenkinsConsole(const std::string& line) const {
    return line.find("Console Output") != std::string::npos ||
           line.find("Started by") != std::string::npos;
}

bool JenkinsParser::isBuildStart(const std::string& line) const {
    return line.find("Started by") != std::string::npos ||
           line.find("Building in workspace") != std::string::npos ||
...
bool JenkinsParser::isStepMarker(const std::string& line) const {
    return line.find("[Pipeline]") != std::string::npos ||
           line.find("+ ") == 0 || // Shell command execution
...
std::string JenkinsParser::extractStatus(const std::string& line) const {
    ...
    if (line.find("Finished: FAILURE") != std::string::npos ||
        line.find("FAILED") != std::string::npos ||
        line.find("ERROR") != std::string::npos) {
        return "failure";
    }
    
    if (line.find("Finished: ABORTED") != std::string::npos ||
