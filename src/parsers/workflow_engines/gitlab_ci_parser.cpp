...
bool GitLabCIParser::canParse(const std::string& content) const {
    ...
    return content.find("Running with gitlab-runner") != std::string::npos ||
           ...
           content.find("Job succeeded") != std::string::npos;
}

std::vector<WorkflowEvent> GitLabCIParser::parseWorkflowLogs(const std::string& content) const {
...
bool GitLabCIParser::isJobEnd(const std::string& line) const {
    return line.find("Job succeeded") != std::string::npos ||
           line.find("Job failed") != std::string::npos ||
...
std::string GitLabCIParser::extractStatus(const std::string& line) const {
    ...
    if (lower_line.find("job failed") != std::string::npos ||
    ...
    if (lower_line.find("warning") != std::string::npos ||
        lower_line.find("deprecated") != std::string::npos) {
        return "warning";
    }
