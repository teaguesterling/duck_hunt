...
bool PylintParser::canParse(const std::string& content) const {
    ...
    if (content.find("Module ") != std::string::npos ||
        ...
        (content.find(": ") != std::string::npos &&
         (content.find("C0") != std::string::npos ||
          content.find("C1") != std::string::npos ||
          content.find("W0") != std::string::npos ||
          content.find("W1") != std::string::npos ||
          content.find("E0") != std::string::npos ||
          content.find("E1") != std::string::npos ||
          content.find("R0") != std::string::npos ||
          content.find("R1") != std::string::npos ||
...
bool PylintParser::isValidPylintOutput(const std::string& content) const {
    ...
    return std::regex_search(content, pylint_module) ||
           std::regex_search(content, pylint_legacy_message) ||
           std::regex_search(content, pylint_modern_message) ||
