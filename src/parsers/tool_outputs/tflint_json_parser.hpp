 ...
 * Handles format: {"issues":[{"rule":{"name":"...","severity":"warning"},"message":"...","range":{"filename":"...","start":{"line":1,"column":1}}}]}
 */
class TflintJSONParser : public IParser {
public:
    bool canParse(const std::string& content) const override;
    std::vector<ValidationEvent> parse(const std::string& content) const override;
    TestResultFormat getFormat() const override { return TestResultFormat::TFLINT_JSON; }
    std::string getName() const override { return "tflint"; }
