...
public:
    ...
    TestResultFormat getFormat() const override { return TestResultFormat::CLIPPY_JSON; }
    std::string getName() const override { return "clippy_json"; }
    int getPriority() const override { return 75; }  // Medium-high priority for Rust linting
